using Detran.Kanban.Application;
using Detran.Kanban.Infrastructure;
...
try
{
    Log.Information("Iniciando Detran.Kanban.Api");
    ...
    builder.Services.AddSingleton<Detran.Kanban.Application.Interfaces.IFileStorage>(
        new Detran.Kanban.Infrastructure.Storage.LocalFileStorage(
    ...
    builder.Services.AddIdentityCore<IdentityUser>(options =>
        ...
        .AddEntityFrameworkStores<Detran.Kanban.Infrastructure.Persistence.AppDbContext>();
    ...
    builder.Services.AddSwaggerGen(c =>
    {
        ...
        c.OperationFilter<Detran.Kanban.Api.OpenApi.OrganizationHeaderOperationFilter>();
        c.OperationFilter<Detran.Kanban.Api.OpenApi.StandardResponsesOperationFilter>();
    ...
    builder.Services.AddScoped<Detran.Kanban.Application.Interfaces.IBoardRealtimeNotifier,
        Detran.Kanban.Api.Realtime.SignalRBoardRealtimeNotifier>();
    builder.Services.AddScoped<Detran.Kanban.Api.Services.JwtTokenService>();
    ...
    app.UseMiddleware<Detran.Kanban.Api.Middleware.MapeamentoDeErrosMiddleware>();
    app.UseMiddleware<Detran.Kanban.Api.Middleware.SecurityHeadersMiddleware>();
    ...
    app.UseMiddleware<Detran.Kanban.Api.Middleware.AuditContextMiddleware>();
    app.UseMiddleware<Detran.Kanban.Api.Middleware.OrganizationContextMiddleware>();
    ...
    app.MapControllers();
    app.MapHub<Detran.Kanban.Api.Realtime.BoardHub>("/hubs/boards");
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        try
        {
            var dbContext = services.GetRequiredService<Detran.Kanban.Infrastructure.Persistence.AppDbContext>();
            ...
            if (app.Environment.IsDevelopment())
            {
                ...
                await Detran.Kanban.Infrastructure.Persistence.DbInitializer.SeedDataAsync(
